        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-black/30 transition-colors duration-500 ease-in-out group-hover:bg-[#12223a]/85 z-10" />
              ...
              <div className="absolute inset-0 z-20 flex flex-col items-center justify-center p-8 md:p-12 text-center text-white">
                ...
                <h3 className="text-white text-base md:text-lg font-semibold tracking-[0.2em] uppercase transition-all duration-700 ease-in-out transform translate-y-[140px] md:translate-y-[170px] group-hover:translate-y-0">
                  {feature.title}
                </h3>
                
                {/* Description: Fades in below the title */}
                <div className="opacity-0 group-hover:opacity-100 transition-all duration-700 ease-in-out transform translate-y-10 group-hover:translate-y-0 mt-4 px-4">
